...
- `days_from_study_start` — integer count from October 1, 2025
...
- weekly mean line;
- optional confidence/uncertainty band or observed-range indicator;
- event markers on documented dates;
- communication-volume indicator considered as a secondary panel or supplementary figure.
...
The richer primary-role typology (ADV, LEG, RES, SER, CBO, FAI, DEV, HYB) should remain available for secondary analysis.
