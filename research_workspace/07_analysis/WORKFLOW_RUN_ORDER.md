...
This file is the canonical execution order for moving from the frozen collection corpus to analysis.

## 0. Preconditions
- Raw collection remains unchanged in `05_data/raw/`.
...
```bash
python research_workspace/07_analysis/build_analysis_ready_dataset.py
```

Expected outputs:
- `05_data/processed/communication_master_all_verified_v1.csv`
- `05_data/processed/communication_master_primary_v1.csv`
- `05_data/processed/communication_candidates_unresolved_v1.csv`
- `05_data/processed/communication_master_qc_summary_v1.csv`
...
```bash
python research_workspace/07_analysis/select_reliability_pilot.py
```

Expected output:
- `05_data/processed/reliability_pilot_sample_v1.csv`
...
Expected output:
- `05_data/processed/manual_coding_sheet_v1.csv`

Use:
- `06_codebooks/affective_intermediation_coding_codebook_v1.md`
- `06_codebooks/temporal_emotion_arc_codebook.md`
- `06_codebooks/analysis_ready_master_schema_v1.md`
...
- `07_analysis/reliability_pilot_protocol_v1.md`
...
Expected output:
- `05_data/processed/communication_master_coded_v1.csv`

## 7. Validate coded dataset
Run:

```bash
python research_workspace/07_analysis/validate_analysis_dataset.py
```
...
Use:
- `07_analysis/external_event_chronology_v1.csv`
...
```bash
python research_workspace/07_analysis/run_core_analysis.py
```
...
```bash
python research_workspace/07_analysis/run_matched_engagement_analysis.py
```
